    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            HStack(spacing: 2) {
                ...
                TextField("Search for a city or airoport", text: $searchText)
            }
            .foregroundColor(.secondary)
            ...
            .innerShadow(shape: RoundedRectangle(cornerRadius: 10), color: .black.opacity(0.25), lineWight: 2, offsetX: 0, offsetY: 2, blur: 2)
            
        }
        .frame(height: 106, alignment: .top)
        .padding(.horizontal, 16)
        .padding(.top, 49)
        .backgrondBlur(radius: 20, opaque: true)
